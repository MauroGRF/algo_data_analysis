...
# * Especifique la media aritmética 

df_rating = df[df["Rating"] >= 4.9] 
print(df_rating["Installs"].mean())

# y la mediana del número de instalaciones de aplicaciones (Instalaciones)
print(df_rating["Installs"].median())